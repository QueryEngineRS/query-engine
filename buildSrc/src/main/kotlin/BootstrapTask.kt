...
open class BootstrapTask : DefaultTask() {
    ...
    fun boostrap() {
        if (project == project.rootProject) {
            ...
            val baseBootstrapArray = getBootstrap("$bootstrapDir/plugins.json") ?: throw RuntimeException("Base bootstrap is null!")
            val baseBootstrap = baseBootstrapArray.getJSONArray(0)
